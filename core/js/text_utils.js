...
/**
 * Splits a long string into chunks no longer than maxLength, breaking on the
 * given delimiter character (defaults to newline).
 *
 * @param {string} input
 * @param {{ maxLength?: number, char?: string }} [options]
 * @returns {string[]}
 */
